...
**1.** Run the following commands as root. The script installs IungoPBXPBX, FreeSWITCH release package and its dependencies, iptables, Fail2ban, NGINX, PHP-FPM and PostgreSQL.
...
If using **Debian on Proxmox LXC** containers please run the following **BEFORE** starting the IungoPBXPBX install.
...
::
   ...
   Additional information.
      https://iungopbx.com/support.php
      https://www.iungopbx.com
      http://docs.iungopbx.com
      https://www.iungopbx.com/training.php
