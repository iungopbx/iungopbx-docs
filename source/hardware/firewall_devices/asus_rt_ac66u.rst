...
This guide was created for the ASUS RT-AC66U router with Firmware Version 3.0.0.4.380_8120.  IungoPBXPBX is in the cloud with a public IP, and the ASUS RT-AC66U router is at the customer’s location with the extensions behind it.  The RT-AC66U is a “prosumer” grade router.  It has good performance for the dollar and is a good choice for home offices.
...
.. image:: ../../_static/images/firewall/iungopbx_asus_traffic_manager_qos.png
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_asus_traffic_manager_qos_rules.png
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_asus_traffic_manager_qos_note.png
        :scale: 85%
...
This guide was created for the ASUS RT-AC66U router with Firmware Version 3.0.0.4.380_8120.  IungoPBXPBX is in the cloud with a public IP, and the ZyXEL USG60 router is at the customer’s location with the extensions behind it.  The RT-AC66U is a “prosumer” grade router.  It has good performance for the dollar and is a good choice for home offices.
...
.. image:: ../../_static/images/firewall/iungopbx_asus_sip_alg.png
        :scale: 85%
