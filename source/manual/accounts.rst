...
-  `Gateways </en/latest/Gateways/gateway_inbound_outbound/gateway1.html>`__ - to define the outbound gateways that are used to make calls to destinations outside of your IungoPBXPBX/FreeSWITCH server
