...
This guide was created using V4.2/4.25 firmware on a ZyXEL USG60 series UTM router.  IungoPBXPBX is in the cloud with a public IP, and the ZyXEL USG60 router is at the customer’s location with the extensions behind it.
...
Create a name, and enter the static public IP of your IungoPBXPBX.  If you have more than one, such as a failover, add that as well and create a group.

.. image:: ../../_static/images/firewall/iungopbx_zyxel_usg60_object_address.png
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_zyxel_usg60_object_service.png
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_zyxel_usg60_bwm_.png
        :scale: 85%
