...
.. image:: ../../_static/images/firewall/iungopbx_ubnt_edgerouterx.jpg
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_ubnt_port_forward.jpg
        :scale: 85%


* Optional: SSH port 22 is optional.
* Required: Sip port range 5060-5090 is recomended.
* Required: HTTPS port 443 is required in order to access your IungoPBXPBX installation and phone provisioning.
...
.. image:: ../../_static/images/firewall/iungopbx_ubnt_firewall_policies_enable_outside_lan_gui_access.jpg
        :scale: 85%
...
.. image:: ../../_static/images/firewall/iungopbx_ubnt_firewall_policies_enable_outside_lan_gui_access1.jpg
        :scale: 85%
...
* A static route is needed on the other router in order for traffic to reach your IungoPBXPBX installation and is only needed if the Edgerouter is the double NAT.
...
* **Router A Destination IP address:** 192.168.1.38 This is the IP that the Edgerouter gave to your IungoPBXPBX install.
...
.. image:: ../../_static/images/firewall/iungopbx_ubnt_static_route_other_router.jpg
        :scale: 85%
